...
const PsbBanner = '/new-assets/P-Type Swing Barrier.png';
const banner = '/assets/ptype.jpg';
...
export default function PtypeSwingBarrier() {
  const [activeTab, setActiveTab] = useState("description");

  return (
    <div className="w-full h-full relative overflow-hidden">
      <Head>
        <title>P-Type Swing Barrier PSB-606 | Synergy Access Pvt. Ltd.</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
        <meta name="description" content="P-Type Swing Barrier PSB-606 for accessible, secure entry. RFID, microprocessor, and sensor integration for universal access control." />
      </Head>
        ...
        >
          ...
          <motion.div className="lg:col-span-2" variants={itemAnimation}>
            ...
            >
              <img
                src={PsbBanner}
                alt="P-Type Swing Barrier"
                className="object-cover w-full h-full max-h-96"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                <h2 className="text-2xl font-bold sm:text-3xl">PSB-606 P-Type Swing Barrier</h2>
                <p className="mt-2 text-blue-100">Universal access control solution</p>
              </div>
            </motion.div>
                    ...
                    >
                      <motion.div variants={itemAnimation}>
                        <h2 className="mb-4 text-2xl font-bold text-gray-900">
                          Universal Access Control Solution
                        </h2>
                        <p className="text-lg leading-relaxed text-gray-600">
                          The P-Type Swing Barrier PSB-606 combines mechanical, electronic, and microprocessor control 
                          with RFID technology to provide accessible entry solutions for all users, including those 
                          ...
                          {[
                            ...
                            },
                            {
                              ...
                              features: [
                                ...
                                "IP54 rated (sheltered outdoor use)",
                                "35kg robust design"
                              ]
                            },
                            {
                              ...
                              features: [
                                "20-25 persons/minute throughput",
                            ...
                            },
                            {
                              ...
                              features: [
                                ...
                                "Microprocessor control hardware",
                      ...
                      <motion.div variants={itemAnimation} className="space-y-4">
                        <h3 className="text-xl font-bold text-blue-700">Accessibility Features</h3>
                        <ul className="grid grid-cols-1 gap-4 text-gray-600 sm:grid-cols-2">
                          <li className="flex items-start">
                            <span className="mr-2 text-blue-500">✓</span>
                            <span>Wide 900mm passage for wheelchair access</span>
                          </li>
                          <li className="flex items-start">
                            <span className="mr-2 text-blue-500">✓</span>
                            <span>Gentle swing mechanism for easy operation</span>
                          </li>
                          <li className="flex items-start">
                            <span className="mr-2 text-blue-500">✓</span>
                          ...
                          <li className="flex items-start">
                            <span className="mr-2 text-blue-500">✓</span>
                            <span>Visual and audible signals for all users</span>
                          </li>
                        </ul>
                      </motion.div>
                    </motion.div>
                        ...
                        <table className="min-w-full border border-gray-200">
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              ...
                              <td className="px-4 py-3">PSB-606</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Throughput</td>
                              <td className="px-4 py-3">20-25 Person/min</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Dimensions (WxHxL)</td>
                              <td className="px-4 py-3">280mm x 950mm x 440mm</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Passage Width</td>
                              <td className="px-4 py-3">900mm</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Power Supply</td>
                              <td className="px-4 py-3">220-240 VAC, 50/60 Hz</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Power Consumption</td>
                              <td className="px-4 py-3">50W</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Weight</td>
                              <td className="px-4 py-3">35kg</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Material</td>
                              <td className="px-4 py-3">AISI 304/316 Stainless Steel</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Duty Cycle</td>
                              <td className="px-4 py-3">Continuous Use</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 font-semibold bg-gray-50">Environment</td>
                              <td className="px-4 py-3">Indoor/Outdoor (if sheltered)</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
