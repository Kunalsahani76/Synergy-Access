...
const HhmdBanner = '/new-assets/HANDHELD METAL DETECTOR.png';
import Image from "next/image";
const banner = '/assets/hhmd.jpeg';
...
export default function Hhmd() {
  const [activeTab, setActiveTab] = useState("description");

  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <Head>
        <title>Handheld Metal Detector (HHMD) | Synergy Access Pvt. Ltd.</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
        <meta name="description" content="Handheld Metal Detector (HHMD) for security screening. Portable, precise, and reliable for airports, events, and secure facilities." />
      </Head>
        ...
        >
          ...
          <motion.div className="lg:col-span-2" variants={itemAnimation}>
            ...
            >
              <img
                src={HhmdBanner}
                alt="Handheld Metal Detector"
                className="object-cover w-full h-full max-h-96"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                <h2 className="text-2xl font-bold sm:text-3xl">HHMD-5000 Handheld Metal Detector</h2>
                <p className="mt-2 text-blue-100">Precision security screening for all environments</p>
              </div>
            </motion.div>
                    ...
                    >
                      <motion.div variants={itemAnimation}>
                        <h2 className="mb-4 text-2xl font-bold text-gray-900">
                          Precision Security Screening
                        </h2>
                        <p className="text-lg leading-relaxed text-gray-600">
                          Our Handheld Metal Detector (HHMD) provides reliable and portable security screening, 
                          offering the perfect solution for quick and efficient metal detection in various 
                          security scenarios from airports to public events.
                        </p>
                      </motion.div>
                          ...
                          {[
                            {
                              ...
                              features: [
                                "High sensitivity to all metal types",
                        ...
                        <div className="p-5 bg-gray-50 rounded-xl">
                          <ul className="space-y-3 text-gray-700">
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Model:</span> HHMD-5000
                            </li>
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Detection Depth:</span> Up to 20cm (depending on metal type)
                            </li>
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Power Source:</span> 2x AA batteries (included)
                            </li>
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Battery Life:</span> 40+ hours continuous use
                            </li>
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Weight:</span> 350g (without batteries)
                            </li>
                            <li className="pb-2 border-b border-gray-200">
                              <span className="font-semibold">Dimensions:</span> 38cm x 8cm x 5cm
                            </li>
                            <li>
                              <span className="font-semibold">Operating Temperature:</span> -10°C to 55°C
                            </li>
                          </ul>
                        </div>
                      </motion.div>
                      ...
                      {/* Use Cases */}
                      <motion.div variants={itemAnimation} className="space-y-6">
                        <h3 className="text-xl font-bold text-blue-700">Ideal For</h3>
                        <div className="grid gap-6 sm:grid-cols-2">
                          {[
                            {
                              title: "Airport Security",
                              description: "Secondary screening at checkpoints"
                            },
                            {
                              title: "Event Security",
                              description: "Quick screening at entry points"
                            },
                            {
                              title: "Corporate Facilities",
                              description: "Employee and visitor screening"
                            },
                            {
